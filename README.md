...
### `workflow-eta` — ralplan·ultragoal 남은 시간
...
- 원문: [`plugins/oh-my-gjc/skills/workflow-eta/SKILL.md`](./plugins/oh-my-gjc/skills/workflow-eta/SKILL.md)

### GJC 0.11 SDK lab

`workflow-eta`의 공식 `@gajae-code/bridge-client` 기반 읽기 전용 런타임이자 개발자용 검사 도구다.
...
`OMG_WORKFLOW_ETA_RUNTIME=0`으로 런타임 설치를 끌 수 있다.
