...
```
One install brings the whole suite (13 capabilities). There are no separate/optional plugins to add.
...
ls ~/.gjc/agent/skills/                            # 13 skills (easy-answer, gate-briefing, …, tower)
