...
**Gajae Code(gjc)의 oh-my 단일 플러그인.** 한 번 설치로 스킬 7개 + 커맨드 10개
(`/omg` + `/omg:*` 9개)가 전부 들어온다. `/omg:time-left`는 Linux+Bun 1.3.14+와
...
### 스킬
`adaptive-response` · `no-english` · `time-left` · `extragoal` · `insane-review` · `lazycodex-gjc` · `deep-onboarding`
